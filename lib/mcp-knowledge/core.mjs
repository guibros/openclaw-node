...
// bge-m3 truncates at 8192 word-piece tokens (~32000 chars) — accommodates full
// session turns without losing tail content. Multilingual (100+ languages) for
 ...
 */
export async function searchSessions(db, query, limit = 10) {
