...
const tracer = createTracer('mcp-knowledge-server');
...
const createMcpServer = tracer.wrap('createMcpServer', function createMcpServer(engine) {
...
const startStdio = tracer.wrapAsync('startStdio', async function startStdio(engine) {
...
const startHttp = tracer.wrapAsync('startHttp', async function startHttp(engine, port, host) {
...
const registerNatsTools = tracer.wrapAsync('registerNatsTools', async function registerNatsTools(engine) {
