...
const tracer = createTracer('pair-transport-teams');
...
class TeamsTransport {
  ...
  constructor(teamName, artifactDir) {
    ...
    tracer.wrapClass(this, [
      'getState', 'setState', 'logMessage', 'getMessages',
      'publishArtifact', 'listArtifacts', 'setTurn', 'getTurn',
      'registerAgent', 'setAgentStatus', 'isComplete', 'isAborted',
      'markDone', 'markAborted', 'getSummary'
    ], { tier: 3, category: 'state_transition' });
