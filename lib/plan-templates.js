...
const tracer = createTracer('plan-templates');
...
module.exports = {
  loadTemplate: tracer.wrap('loadTemplate', loadTemplate, { tier: 3 }),
  listTemplates: tracer.wrap('listTemplates', listTemplates, { tier: 3 }),
  validateTemplate: tracer.wrap('validateTemplate', validateTemplate, { tier: 3 }),
  instantiateTemplate: tracer.wrap('instantiateTemplate', instantiateTemplate, { tier: 3 }),
  substituteVars: tracer.wrap('substituteVars', substituteVars, { tier: 3 }),
};
