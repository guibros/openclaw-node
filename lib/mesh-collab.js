...
function createSession(taskId, collabSpec) {
  ...
  const resolvedMode = collabSpec.mode || COLLAB_MODE.PARALLEL;
  ...
  return {
    ...
    cooperative: collabSpec.mode === COLLAB_MODE.COOPERATIVE ? {
    ...
    collaborative: collabSpec.mode === COLLAB_MODE.COLLABORATIVE ? {
