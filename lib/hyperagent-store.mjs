...
const _createHyperAgentStore = function createHyperAgentStore(opts = {}) {
  ...
  tracer.wrapClass(instance, [
    ...
    'computeStats', 'putStrategy', 'getStrategy', 'listStrategies', 'archiveStrategy',
    'putReflection', 'writeSynthesis', 'listReflections', 'getLastReflection',
    'getPendingSynthesis', 'getPreviousReflection', 'expireStalePending',
    'putProposal', 'startShadowEval', 'approveProposal', 'rejectProposal',
    'getProposals', 'checkShadowWindows', 'getStats', 'close',
  ], { tier: 3, category: 'io' });
  return instance;
};
