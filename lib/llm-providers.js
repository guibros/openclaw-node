...
module.exports = {
  ...
  registerProvider: tracer.wrap('registerProvider', registerProvider, { tier: 2, category: 'state_transition' }),
  validateShellCommand: tracer.wrap('validateShellCommand', validateShellCommand, { tier: 2, category: 'compute' }),
  loadCustomProviders,
  makeGenericProvider,
};
