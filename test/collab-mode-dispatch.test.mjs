...
test('isModeImplemented: legacy + circling + cooperative + collaborative live; management not', () => {
  ...
  assert.ok(isModeImplemented(COLLAB_MODE.COLLABORATIVE), 'collaborative went live in 3.3');
