...
test('parses null and boolean values', () => {
...
test('matches path prefix with double star', () => {
...
test('loads rules from directory', () => {
  setup();
...
test('matches rules by scope paths', () => {
  const rules = [
...
test('returns empty for no scope paths', () => {
...
test('sorts by tier precedence then priority', () => {
  const rules = [
...
test('formats rules into markdown', () => {
  const rules = [
...
test('truncates at MAX_RULES_CHARS', () => {
...
test('detects from package.json deps', () => {
  setup();
...
test('detects from config files', () => {
  setup();
...
test('filters framework rules by detected frameworks', () => {
  const rules = [
...
test('passes through non-framework rules', () => {
  const rules = [
