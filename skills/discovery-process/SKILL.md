...
description: "Use when running a full product discovery cycle. Orchestrates problem framing, customer interviews, insight synthesis, and solution experiments across 6 phases over 2-4 weeks to validate before building."
type: workflow
triggers:
  - "run a product discovery cycle"
  - "help me validate this problem before we build"
  - "guide me through customer discovery"
  - "how do I structure a discovery sprint"
  - "plan a discovery process from hypothesis to validation"
negative_triggers:
  - "write a PRD for this feature"
  - "set up user testing for our prototype"
