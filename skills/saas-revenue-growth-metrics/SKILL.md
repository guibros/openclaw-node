...
description: "Use this to calculate and interpret SaaS revenue, retention, and growth metrics including MRR/ARR, ARPU/ARPA, churn rate, NRR, expansion revenue, and cohort analysis."
type: component
triggers:
  - "calculate my MRR and ARR"
  - "help me analyze SaaS revenue metrics"
  - "what's my net revenue retention"
  - "run a cohort analysis on churn"
  - "analyze my SaaS growth metrics"
negative_triggers:
  - "calculate CAC or LTV"
  - "help me with burn rate or runway"
