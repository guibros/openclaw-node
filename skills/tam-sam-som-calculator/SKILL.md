...
description: "Use this to calculate TAM, SAM, and SOM for a product idea through adaptive questions, producing citation-backed market size estimates for investor decks and strategic planning."
type: interactive
triggers:
  - "calculate my TAM SAM SOM"
  - "help me size my market"
  - "I need market size estimates for my pitch deck"
