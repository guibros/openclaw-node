---
name: auto-updater
description: "Set up daily auto-updates for Clawdbot and all installed skills via cron. Checks for updates, applies them, and reports what changed. Use when configuring automatic update schedules."
triggers:
  - "auto update clawdbot"
  - "set up daily updates"
  - "update all skills"
  - "auto-updater"
negative_triggers:
  - "update a single skill manually"
