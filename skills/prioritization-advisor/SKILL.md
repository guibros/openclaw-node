...
description: >-
  Guide product managers in choosing the right prioritization framework (RICE, ICE, Kano, etc.)
  by asking adaptive questions about product stage, team context, and decision-making needs.
  Use this when you need to pick or switch a prioritization framework for your backlog.
type: interactive
triggers:
  - "help me pick a prioritization framework"
  - "which prioritization method should I use"
  - "how should I prioritize my backlog"
  - "RICE vs ICE vs Kano"
  - "I need a way to rank features"
negative_triggers:
  - "score these features for me"
  - "build me a roadmap"
  - "write user stories for my backlog"
---
