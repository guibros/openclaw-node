...
description: "Self-evolution engine that analyzes agent runtime history to identify improvements and applies protocol-constrained evolution via GEP. Use when the agent needs to evolve, self-repair after errors, or run an automated improvement cycle."
