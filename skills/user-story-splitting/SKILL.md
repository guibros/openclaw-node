...
description: >-
  ...
  using 8 systematic splitting patterns (workflow steps, business rules, data variations, etc.).
  Use this when a story is too big for a single sprint and needs strategic decomposition.
type: component
triggers:
  - "split this user story"
  - "this story is too big"
  - "break down this epic into stories"
  - "help me decompose this feature"
negative_triggers:
  - "write a user story from scratch"
  - "create a story map"
  - "prioritize my stories"
---
