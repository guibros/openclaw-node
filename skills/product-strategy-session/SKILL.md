...
description: "Use this to run a full product strategy session orchestrating positioning, problem framing, customer discovery, and roadmap planning into a 2-4 week end-to-end process."
type: workflow
triggers:
  - "run a product strategy session"
  - "help me build a product strategy"
  - "I need to create a product strategy from scratch"
  - "guide me through strategic product planning"
  - "let's do end-to-end product strategy"
negative_triggers:
