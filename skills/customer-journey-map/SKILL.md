...
description: "Use this to create a customer journey map documenting actions, touchpoints, emotions, KPIs, and team ownership across awareness-to-loyalty stages. Produces a structured artifact for cross-functional alignment."
type: component
triggers:
  - "create a customer journey map"
  - "map our customer touchpoints end to end"
  - "document the customer experience across stages"
  - "I need a journey map template"
negative_triggers:
  - "map our internal service processes"
  - "create a user flow diagram for the app"
