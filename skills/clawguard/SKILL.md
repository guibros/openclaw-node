---
name: clawguard
description: "Install and configure ClawGuard — an LLM-as-a-Judge security plugin that evaluates tool calls before execution and blocks risky operations. Use when setting up or configuring ClawGuard guardrails."
triggers:
  - "install clawguard"
  - "configure clawguard"
  - "tool call security"
