...
description: "Advanced filesystem operations — listing, searching, batch copying, and directory analysis with tree visualization. Use when you need structured file listing, content search, batch file operations, or directory statistics."
