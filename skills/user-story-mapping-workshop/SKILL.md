...
description: "Use this to create a user story map through guided questions, generating a two-dimensional map with backbone activities, prioritized user tasks, and release slices for MVP planning."
type: interactive
triggers:
  - "create a user story map"
  - "run a story mapping workshop"
  - "help me plan releases with story mapping"
  - "I need to map my backlog visually"
  - "build a walking skeleton for my product"
negative_triggers:
  - "write individual user stories"
  - "create a Gantt chart or project plan"
  - "prioritize my existing backlog"
---
