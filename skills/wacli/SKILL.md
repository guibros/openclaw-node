---
name: wacli
description: Send WhatsApp messages to third parties or search/sync WhatsApp chat history via the wacli CLI. Use when the user asks to message someone on WhatsApp or look up past WhatsApp conversations.
homepage: https://wacli.sh
triggers:
  - "send a whatsapp message"
  - "message them on whatsapp"
  - "search my whatsapp history"
  - "find that whatsapp conversation"
