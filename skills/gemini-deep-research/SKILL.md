...
description: "Run long-running research via Gemini Deep Research Agent with systematic web search and multi-source synthesis. Use for competitive analysis, market research, technical investigations, or any complex topic requiring a structured Gemini-powered report."
triggers:
  - "use gemini to research"
  - "run gemini deep research on"
  - "do a competitive analysis with gemini"
