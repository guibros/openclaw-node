...
description: "Use this to analyze macro-environmental factors (Political, Economic, Social, Technological, Environmental, Legal) affecting your product. Identifies external opportunities, threats, and strategic risks."
type: component
triggers:
  - "run a PESTEL analysis"
  - "what external factors affect this product"
  - "assess macro environment for market entry"
  - "analyze political and economic risks"
  - "do a macro-environment scan"
negative_triggers:
  - "analyze our competitors"
  - "do an internal SWOT"
  - "review our product metrics"
---
