...
description: "Use when you need to create a PRD from scratch. Orchestrates problem framing, persona definition, strategic context, solution overview, success metrics, user stories, and scope into a complete Product Requirements Document across 8 structured phases."
type: workflow
triggers:
  - "help me write a PRD"
  - "create a product requirements document"
  - "I need to document requirements for this feature"
  - "turn these scattered notes into a structured PRD"
  - "start a new PRD for this initiative"
negative_triggers:
  - "write a one-line user story"
  - "fix a small bug"
