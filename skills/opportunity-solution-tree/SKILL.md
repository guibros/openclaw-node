...
description: "Use when you need to move from a vague stakeholder request to structured discovery. Builds an Opportunity Solution Tree (OST) by extracting a target outcome, generating customer problems to solve, mapping candidate solutions, and selecting the best proof-of-concept."
type: interactive
triggers:
  - "build an opportunity solution tree"
  - "what problems should we solve to hit this outcome"
  - "turn this stakeholder request into structured discovery"
  - "prioritize which customer problem to tackle first"
  - "help me avoid feature-factory mode"
negative_triggers:
  - "write user stories for a validated solution"
