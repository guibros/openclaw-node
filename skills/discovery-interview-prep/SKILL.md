...
description: "Use this to prepare for customer discovery interviews. Asks adaptive questions about research goals, customer segments, constraints, and methodology to output a tailored interview plan with questions, bias warnings, and success criteria."
type: interactive
triggers:
  - "prepare for customer interviews"
  - "help me plan discovery interviews"
  - "I need to interview users"
  - "set up a customer research plan"
