...
name: proto-persona
description: >-
  Create an assumption-based persona profile synthesizing user research, market data, and stakeholder knowledge
  into a working hypothesis about your target user. Use this when starting a new product or feature
  and you need a lightweight persona to align the team before deep research.
type: component
triggers:
  - "help me create a persona"
  - "who is our target user"
  - "build a proto-persona"
  - "I need a user profile for this feature"
negative_triggers:
  - "validate my persona with data"
  - "run user interviews"
  - "segment my analytics"
---
