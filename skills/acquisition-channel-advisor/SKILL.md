...
description: "Use when evaluating whether to scale, test, or kill an acquisition channel. Analyzes unit economics (CAC, LTV, payback), customer quality (retention, NRR), and scalability to deliver data-driven channel investment recommendations."
type: interactive
triggers:
  - "should we scale this acquisition channel"
  - "evaluate our marketing channel ROI"
  - "which channels should we kill or keep"
  - "help me decide where to allocate marketing budget"
  - "analyze our CAC and LTV by channel"
negative_triggers:
  - "how do I set up Google Ads"
  - "write ad copy for our campaign"
