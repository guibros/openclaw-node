---
name: byterover
description: "Manages project knowledge using ByteRover context tree. Query to retrieve patterns/conventions, curate to persist decisions and insights. Use when you need cross-session project knowledge or want to store learned patterns."
triggers:
  - "byterover"
  - "brv query"
