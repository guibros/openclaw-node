...
description: "Use this when you have a hypothesis but aren't sure which PoL probe type to use. Walks through your risk, timeline, and resources to recommend the cheapest prototype that tells the harshest truth."
type: interactive
triggers:
  - "which probe type should I use"
  - "help me pick a validation method"
  - "what's the right prototype for this hypothesis"
  - "should I do a feasibility check or task test"
  - "advise on PoL probe selection"
negative_triggers:
  - "document a PoL probe"
  - "build a prototype"
  - "I already know which probe to use"
---
