...
description: >-
  Articulate a problem from the user's perspective using an empathy-driven "I am / Trying to / But / Because / Which makes me feel" framework.
  Use this when you need to frame a user problem before jumping to solutions.
type: component
triggers:
  - "help me write a problem statement"
  - "frame the user problem"
  - "what problem are we solving"
  - "I need to articulate the user pain point"
negative_triggers:
  - "write a PRD"
