---
name: soulcraft
description: "Creates or improves SOUL.md files for OpenClaw agents through guided conversation. Use when designing agent personality, crafting a soul, or refining an existing agent's character."
triggers:
  - "help me create a soul"
  - "improve my agent's personality"
  - "craft a SOUL.md"
  - "design my agent's character"
  - "refine my soul file"
negative_triggers:
  - "soul music playlist"
