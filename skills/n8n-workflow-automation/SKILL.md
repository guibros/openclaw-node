...
description: "Design and output n8n workflow JSON with triggers, idempotency, error handling, logging, retries, and human-in-the-loop review queues. Use when you need an auditable n8n automation that won’t silently fail."
triggers:
  - "build an n8n workflow"
  - "create an n8n automation"
  - "add error handling to this n8n flow"
  - "make this n8n workflow idempotent"
negative_triggers:
