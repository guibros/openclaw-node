---
name: lean-ux-canvas
description: "Use when starting a product initiative to frame work around a business problem instead of a solution. Walks through all 8 boxes of Jeff Gothelf's Lean UX Canvas v2 -- exposing assumptions, crafting hypotheses, and designing the smallest experiment to learn first."
type: interactive
triggers:
  - "fill out a Lean UX Canvas"
  - "frame this initiative around a business problem"
  - "help me write hypotheses for this feature"
  - "what assumptions are we making about this product idea"
