---
name: storyboard
description: "Use this to create a 6-frame visual storyboard showing a user's journey from problem to solution, using a classic storytelling arc to build empathy and make abstract product concepts concrete."
type: component
triggers:
  - "create a storyboard for my product"
  - "build a 6-frame user story narrative"
  - "help me visualize the user journey as a story"
  - "I need a storyboard to pitch a feature"
negative_triggers:
