...
description: "Use when you want a guided, interactive session to build a customer journey map. Walks through persona selection, scenario definition, phase mapping, emotion capture, and opportunity prioritization via adaptive questions."
type: interactive
triggers:
  - "walk me through building a customer journey map"
  - "run a journey mapping workshop"
  - "help me identify pain points across the customer experience"
  - "facilitate a customer journey mapping session"
negative_triggers:
  - "create a service blueprint"
  - "plan a user story mapping session"
  - "diagram our internal operations"
---
