# Self-Improvement Templates & Detailed Examples

Extracted from SKILL.md for reference. See the main SKILL.md for overview and quick reference.
...
**Setup**: See "OpenClaw Setup" section in SKILL.md
