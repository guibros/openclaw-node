...
description: "Use when evaluating a proposed pricing change (price increase, new tier, add-on, discount). Models ARPU/ARPA lift, conversion impact, churn risk, NRR effects, and CAC payback to deliver a go/no-go recommendation with supporting math."
type: interactive
triggers:
  - "evaluate this pricing change"
  - "should we raise prices"
  - "what's the financial impact of changing our pricing"
  - "model the churn risk of a price increase"
  - "go or no-go on this pricing decision"
negative_triggers:
  - "design a pricing strategy from scratch"
  - "what should we charge for our product"
  - "help me with willingness-to-pay research"
---
