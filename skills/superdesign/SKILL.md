---
name: superdesign
description: "CSS theme patterns and design system reference — modern dark mode, neo-brutalism, glassmorphism, typography, animation micro-syntax. Use when you need specific CSS theme snippets, design system tokens, or frontend style patterns."
triggers:
  - "CSS theme patterns"
