...
description: "Use when you need to define or refine product positioning. Walks through adaptive questions on target customer, unmet need, product category, key benefit, and competitive differentiation to produce a Geoffrey Moore positioning statement."
type: interactive
triggers:
  - "help me position this product"
  - "write a positioning statement"
  - "who is our target customer and how do we differentiate"
  - "run a positioning workshop"
  - "define our competitive positioning before launch"
negative_triggers:
  - "write marketing copy or a tagline"
  - "build a feature comparison chart"
