---
name: pol-probe
description: "Use this to define a Proof of Life (PoL) probe—a lightweight, disposable validation artifact that surfaces harsh truths before expensive development. Documents hypothesis, probe type, success criteria, and disposal plan."
type: component
triggers:
  - "create a PoL probe"
  - "design a proof of life experiment"
  - "I need a lightweight validation test"
  - "define a disposable prototype"
  - "set up a quick hypothesis test"
negative_triggers:
  - "build an MVP"
