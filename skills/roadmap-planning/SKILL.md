...
description: >-
  Guide product managers through strategic roadmap planning: gather inputs, define epics with hypotheses,
  prioritize, sequence into quarters, and communicate to stakeholders. Use this when you need to build
  or refresh an outcome-driven roadmap from scattered feature requests.
type: workflow
triggers:
  - "help me build a product roadmap"
  - "plan my quarterly roadmap"
  - "I need to organize our feature pipeline into a roadmap"
