...
description: "Use when you need to split an epic into vertical user stories. Applies Richard Lawrence's 9 Humanizing Work splitting patterns sequentially, validates INVEST criteria, and evaluates splits for waste elimination."
type: interactive
triggers:
  - "break down this epic into stories"
  - "help me split this user story"
  - "this epic is too big, how do I slice it"
  - "apply story splitting patterns to my epic"
negative_triggers:
  - "write user stories for me"
  - "estimate story points for these tickets"
