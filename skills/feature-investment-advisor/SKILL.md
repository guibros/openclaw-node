...
description: "Use when deciding whether to build a feature based on financial impact. Evaluates revenue connection, cost structure, ROI, and strategic value to deliver build/defer/kill recommendations with supporting math."
type: interactive
triggers:
  - "should we build this feature"
  - "evaluate the ROI of this feature investment"
  - "is this feature worth the engineering cost"
  - "help me make a build vs skip decision"
  - "analyze the financial case for this feature"
negative_triggers:
  - "prioritize my entire product backlog"
  - "write a feature spec or PRD"
  - "how do I price this feature"
---
