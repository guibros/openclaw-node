...
description: "Use this to build a structured recommendation canvas for AI product proposals, covering business outcomes, customer outcomes, problem framing, solution hypotheses, positioning, risks, and value justification."
type: component
triggers:
  - "create a recommendation canvas"
  - "build a product recommendation for stakeholders"
  - "help me propose an AI solution with a canvas"
  - "I need to pitch an AI feature to execs"
negative_triggers:
  - "write a PRD"
  - "create a business case spreadsheet"
