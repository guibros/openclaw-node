...
description: >-
  Visualize the user journey as a hierarchical map: activities, steps, and tasks organized left-to-right
  with vertical priority slicing for release planning. Use this when you need to map a user workflow
  end-to-end and decide what goes into MVP vs. future releases.
type: component
triggers:
  - "create a story map"
  - "map out the user journey"
  - "help me with user story mapping"
  - "I need to visualize the workflow for this feature"
  - "what should go in MVP vs later"
negative_triggers:
  - "write a single user story"
  - "split this story"
  - "build a roadmap"
---
