...
description: "Use when you need a quick formula, benchmark, or red-flag check for any SaaS finance metric. Covers 32+ metrics (ARPU, CAC, LTV, NRR, Rule of 40, etc.) with formulas, benchmarks, and decision frameworks."
type: component
triggers:
  - "what's the formula for LTV"
  - "SaaS metrics cheat sheet"
  - "look up the benchmark for churn rate"
  - "which finance metrics should I track"
  - "quick reference for CAC payback"
negative_triggers:
  - "teach me SaaS finance from scratch"
