...
description: "Tracks agent mistakes, lessons learned, and improvements via heartbeat-triggered reflections. Use when the agent needs to review past errors, log new lessons, or check if a reflection cycle is due."
version: 1.1.1
triggers:
  - "reflect on mistakes"
