...
description: "Use this to frame epics as testable if/then hypotheses with target persona, expected outcome, lightweight experiments, and measurable validation criteria—before committing to a full build."
type: component
triggers:
  - "write an epic hypothesis"
  - "frame this feature as a hypothesis"
  - "create a testable epic"
  - "define experiments for this epic"
  - "how do I validate this epic before building"
negative_triggers:
  - "write user stories"
  - "create a PRD"
