...
description: >-
  Canonical facilitation protocol for interactive skills: one question per turn, progress labels,
  entry-mode selection (Guided / Context dump / Best guess), and interruption-safe flow.
  Use this when running any multi-turn workshop or advisor session.
type: interactive
triggers:
  - "run a workshop"
...
negative_triggers:
  ...
  - "skip the questions and generate output"
