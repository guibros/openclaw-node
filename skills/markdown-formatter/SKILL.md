...
description: "Format, beautify, and lint markdown documents with configurable style guides (CommonMark, GitHub). Use when markdown files need cleanup, consistent formatting, or structural validation."
triggers:
  - "format markdown"
  - "beautify markdown"
  - "lint markdown"
