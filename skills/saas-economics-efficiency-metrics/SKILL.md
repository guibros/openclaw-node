...
description: "Use this to evaluate SaaS unit economics and capital efficiency, including CAC, LTV, payback period, gross margins, burn rate, Rule of 40, and magic number calculations."
type: component
triggers:
  - "calculate my SaaS unit economics"
  - "what's my LTV to CAC ratio"
  - "help me with burn rate and runway analysis"
  - "evaluate my SaaS capital efficiency"
  - "calculate Rule of 40 and magic number"
negative_triggers:
  - "calculate MRR or ARR"
  - "help me with revenue growth metrics"
