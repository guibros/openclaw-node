...
name: user-story
description: >-
  Create user stories in Mike Cohn's "As a / I want / so that" format with Gherkin-style acceptance criteria.
  Use this when you need to translate a user need into an actionable, testable development ticket.
type: component
triggers:
  - "write a user story"
  - "help me draft user stories"
  - "I need acceptance criteria for this feature"
  - "convert this requirement to a user story"
negative_triggers:
  - "split this story into smaller ones"
  - "create a story map"
