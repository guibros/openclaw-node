...
description: "Use when you suspect you might be solving the wrong problem. Walks through MITRE's Problem Framing Canvas -- Look Inward (assumptions and biases), Look Outward (who experiences it, who benefits), and Reframe -- to produce a clear, equity-driven problem statement and How Might We question."
type: interactive
triggers:
  - "help me frame this problem before we jump to solutions"
  - "run a problem framing canvas"
