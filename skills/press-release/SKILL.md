---
name: press-release
description: "Use this to write an Amazon-style Working Backwards press release before building a product. Forces customer-first thinking, clarifies the problem being solved, and tests whether the product story is compelling."
type: component
triggers:
  - "write a press release for this product"
  - "do a working backwards exercise"
  - "draft an Amazon-style PR/FAQ"
  - "define the product vision as a press release"
  - "test if this product idea is compelling"
negative_triggers:
  - "write a launch-day press release"
