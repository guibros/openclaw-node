---
name: ui-ux-pro-max
description: "UI/UX design intelligence and implementation guidance. Use when the user needs UI layouts, UX flows, design systems, component specs, accessibility audits, or frontend design critique and refinement."
triggers:
  - "design a UI for"
  - "improve the UX of"
