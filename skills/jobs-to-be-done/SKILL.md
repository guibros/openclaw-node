...
description: "Use this to map customer jobs (functional, social, emotional), pains, and gains using the JTBD framework. Uncovers real motivations behind feature requests and reveals unmet needs."
type: component
triggers:
  - "run a jobs-to-be-done analysis"
  - "what jobs are customers hiring us for"
  - "map customer pains and gains"
  - "understand why customers use this product"
  - "do a JTBD canvas"
negative_triggers:
  - "build a persona"
